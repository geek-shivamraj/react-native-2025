...
/**
 *  - We want to render a different UI in landscape mode or when we've less height available.
 *      - We can achieve this via Dimension API to dynamically adjust the layout structure & component structure.
 *      - We want to use such that we listen to changes in dimension inside our component func via useWindowDimensions hook.
 *
 */
