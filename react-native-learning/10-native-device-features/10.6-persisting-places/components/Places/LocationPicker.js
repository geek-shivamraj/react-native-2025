 ...
 *      - We can use Google geocoding API (https://developers.google.com/maps/documentation/geocoding/overview)
 *      - This API translates address to coordinates (geocoding) & vice versa (Reverse geocoding)
